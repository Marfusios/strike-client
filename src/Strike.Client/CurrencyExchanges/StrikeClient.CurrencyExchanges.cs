...
public sealed partial class StrikeClient
{
	...
	public record CurrencyExchangesClient(StrikeClient Client)
	{
		...
		/// </summary>
		public Task<CurrencyExchangeQuote> CreateQuote(CurrencyExchangeQuoteReq req) =>
		...
		/// </summary>
		public Task<CurrencyExchangeExecute> ExecuteQuote(Guid quoteId) =>
		...
		/// </summary>
		public Task<CurrencyExchangeQuote> GetQuote(Guid quoteId) =>
